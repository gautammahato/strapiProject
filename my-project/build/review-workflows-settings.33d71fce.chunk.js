...
`,Q=({children:i,disabled:n=!1,error:w,expanded:s=!1,hasErrorMessage:S=!0,id:K,onToggle:F,toggle:I,size:B="M",variant:c="primary",shadow:P})=>{const C=(0,y.M)(K),X=u.useMemo(()=>({expanded:s,onToggle:F,toggle:I,id:C,size:B,variant:c,disabled:n}),[n,s,C,F,B,I,c]);return(0,e.jsxs)(x.S.Provider,{value:X,children:[(0,e.jsx)(T,{"data-strapi-expanded":s,disabled:n,"aria-disabled":n,expanded:s,hasRadius:!0,variant:c,error:w,shadow:P,children:i}),w&&S&&(0,e.jsx)(v.x,{paddingTop:1,children:(0,e.jsx)(j.Z,{variant:"pi",textColor:"danger600",children:w})})]})}},63081:(E,f,t)=>{"use strict";t.d(f,{v:()=>x});var e=t(85893),u=t(13819),l=t(41580);const x=({children:y,...j})=>{const{expanded:Z,id:v}=(0,u.A)();if(!Z)return null;const R=`accordion-content-${v}`,k=`accordion-label-${v}`,T=`accordion-desc-${v}`;return(0,e.jsx)(l.x,{role:"region",id:R,"aria-labelledby":k,"aria-describedby":T,...j,children:y})}},13819:(E,f,t)=>{"use strict";t.d(f,{A:()=>l,S:()=>u});var e=t(67294);const u=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),l=()=>(0,e.useContext)(u)},74756:(E,f,t)=>{"use strict";t.d(f,{B:()=>i});var e=t(85893),u=t(12645),l=t(71997),x=t(48734),y=t(13819);const j=({expanded:n,disabled:w,variant:s})=>{let S="neutral100";return n?S="primary100":w?S="neutral150":s==="primary"&&(S="neutral0"),S};var Z=t(39785),v=t(52624),R=t(11047),k=t(75515);const T=(0,l.ZP)(Z.A)`
  text-align: left;
